           ...
           <div id="large-header" class="large-header">
			...
			<header class="page-header" style="height:20px">
				...
				<div class="container" style="margin-top:-40px;">
					<div class="row">
						<div class="col-sm-12">
							<span class="text-white alt-font">Empowerment</span>
							<h1 class="text-white">Education</h1>
							<p class="text-white lead">You'll never measure the significance of a 
							
							<br>well <strong>Education</strong> We are here to fuel that learning fire.</p>
						</div>
					</div><!--end of row-->
				</div><!--end of container-->
			</header>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-left">
							<h1>An Early Source Code</h1>
							<p>
<i style="color:#999">"Education is the most powerful weapon that you can use to change the world – <b>Nelson Mandela</b>."</i>
<br>
<br>Here at <b>M.R.I.S</b> we know about the vital part education plays. As a company, we're passionate about providing the tools and services to help learners, teachers, parents, school management and district.
<br>
<br >
...
<br><br>
<b>M.R.I.S</b> have embarked on the <i style="color:#999">#AN EARLY SOURCE CODE</i> program, <i style="color:#999">Everybody in this country should learn how to program a computer, and what is a great way to start than when your still young?"</i><b style="color:#999"><i>Mr. T.M Mlangeni – M.R.I.S CIO</i></b> says.
<br><br>
...
<br><br>
The <b style="color:#999"><i>#AESC</i></b> (An Early Source Code) project is here to develop the future of our country. 
<br><br>
...
<ul style="list-style-position:inside; list-style-type:decimal; line-height:normal;">
<li>Use design thinking and logic to translate their ideas into working applications</li>
<li>Create games, animations and interactive applications</li>
<li>Develop & design websites</li>
<li>Apply MATH and SCIENCE concepts they learned in school while programming</li>
<li>Use computer science concepts such as loops, conditionals and variables</li>
</ul>
<br>
<i style="color:#999"><left>"Because of our program success, we're looking to expand it to other provinces, we're also holding teacher training workshops, and considering using it in other grades, and even suggests  <b>AESC</b> to other schools in our district."</i> <b style="color:#999;"><i><br>Mr. F Hanyahanya(CEO)</left></i></b>
</p>
					...
					<div class="row">
						<div class="col-sm-4" style="width:100%;">
							...
							<div class="feature" >
								...
								<h5 style="font-size:24px; color:white;">ALREADY AT WORK</h5>
								<p align="left" style="font-family:Arial, Helvetica, sans-serif;font-size:14px; color:white">
                                   <b style="color:#000"></b> Working closely with the private sector and being truly dedicated to serving big corporates. We have a project that helps personals of big corporate with IT lessons. Here at M.R.I.S we know how important time is the world of business; we do a walk in approach to the office. 
  ...
  <tr style="border:none;"  align="left"><td style="border:none;" valign="top"><font style="font-size:38px; font-weight:bolder; color:white" > </font></td>
    <td style="font-family:Arial, Helvetica, sans-serif; color:white; font-size:14px; border:none;" >Our clients start doing their lessons when they are free. They call and request a tutor to come to the office to provide them with lessons. You can either request for a one-on-one tutor or a whole office tutor.</td>
  </tr>
  <tr style="font-family:Arial, Helvetica, sans-serif; font-size:12px;border:none;" align="left">
    ...
    <td style="font-family:Arial, Helvetica, sans-serif; color:white; font-size:14px; border:none;" >We have worked with a couple of corporates, just to name a few. We have worked closely with one law firm "L.P Molope Attorneys". We are proud to say that "we have link L.P Molope Attorneys". 
</td>
  </tr>
  <tr style="border:none;" align="left">
    <td style="border:none;"><font style="font-size:38px; font-weight:bolder; color:#000" > </font></td>
    <td style="font-family:Arial, Helvetica, sans-serif; color:white; font-size:14px; border:none;" >We just engage with our clients on their own terms.</td>
  </tr>
<br><br>
</table>
                               </p>
