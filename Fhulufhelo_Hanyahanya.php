...
<html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Fhulufhelo Hanyahanya | M-R.i.S</title>
                                ...
                                <li class="has-dropdown"><a href="#">About Us</a>
									<div class="subnav subnav-fullwidth" style="width: 1170px; left: -200px;">
										...
										<div class="col-md-3">
											...
											<ul class="subnav">
												<li><a href="home-5.html">Education & Training</a></li>
												<li><a href="personal.html">Government Products</a></li>											</ul>	
										</div>
		...
		<div class="main-container">
			<header class="page-header resume-header">
				<div class="background-image-holder parallax-background">
					<img class="background-image" alt="Background Image" src="img/us/4.jpg">
				</div>
				
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<h1 class="text-white space-bottom-medium" style="font-weight:light;">Fhulufhelo Hanyahanya</h1>
							<span>CEO</span>
...
information solutions to address business opportunities Develop
strategic plans for worldwide implantation and operation of client
services, product support, quality assurance, and training.

<br><br>
Initiate and enforce strict budget controls addressing company need
and promoting of growth adept at crisis management, trouble-shooting,
problem-solving, and negotiating and advance positive company image
through public presentations experienced in joint application
development, bench-marking, capacity planning, project and resource
management, cross-functional team training.								
							</p>	
					...
					<div class="row">
						<div class="col-md-3 col-sm-6 text-center">
							<div class="feature feature-icon-large">
								...
								<span class="sub">Multi-Racial Information Systems (M-R.i.S)</span>
							</div>
						</div><!--end 3 col-->
						...
						<div class="col-md-3 col-sm-6 text-center">
							<div class="feature feature-icon-large">
								...
								<div class="pin-body"></div>
								<div class="pin-head"></div>
								<h5>Oct 2012 - Dec 2014</h5>
								<span>SENIOR WEBSITE DESIGNER</span>
								<span class="sub">Multi-Racial Information Systems (M-R.i.S)</span>
							</div>
						</div><!--end 3 col-->
						...
						<div class="col-md-3 col-sm-6 text-center">
							<div class="feature feature-icon-large">
								...
								<span class="sub">The Institute of Business Advisors Southern Africa (IBASA)</span>
							</div>
						</div><!--end 3 col-->
			...
			<section class="stat-counters duplicatable-content">
				...
				<div class="background-image-holder parallax-background">
					<img class="background-image" alt="Background Image" src="img/slides/web-app-titlek.png">
				</div>
...
HTML5, PHP, CSS, wordpress widgets Website & web App Development
Jquery, JavaScript, XML, Scripting language
C#, COBOL, C++, Visual Basic .Net Framework & Development
SQL Server, mySQl, Azure cloud.
Android & iOS Development with Xamarin</p>	
						</div>
					</div><!--end of row-->
