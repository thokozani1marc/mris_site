...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Software Development | M-R.i.S</title>
		...
		<div class="main-container">
			<header class="page-header" style="height:20px">
				<div class="background-image-holder parallax-background" >
					<img class="background-image" alt="Background Image" src="img/slides/cloudsecissue.png">
				</div>
				...
				<div class="container" style="margin-top:-40px;">
					<div class="row">
						<div class="col-sm-12">
							...
							<p class="text-white lead">Advancing technology, switching-on resources. 
							
							<br><strong>Enhance</strong> your company performance with exceptional Tech.</p>
						</div>
					</div><!--end of row-->
				</div><!--end of container-->
			</header>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="feature feature-icon-large">
								...
								<div class="pull-right">
									<h5>SOFTWARE MAINTENANCE SERVICES</h5>
									<p>
									...
									<br><br>
									<strong>M.R.I.S</strong> is always ready to step in and manage the existing software application together with its infrastructure. We will also evaluate your current system and develop additional components to optimize the system. 
									<br><br>
									<strong>Contact M.R.I.S</strong>, to start a healthy working relationship.
									</p>
								</div>
							</div>
						</div><!--end 6 col-->
						...
						<div class="col-sm-6">
							<div class="feature feature-icon-large">
								...
								<div class="pull-right">
									<h5>DATABASE CONVECTION AND MIGRATION</h5>
									<p>
										One of our services is converting ineffective database to more reliable and stable database system which will not fail when required. 
<br><br>
...
<br><br>
<strong>Contact us for quotation our affordable and professional services in all your programing needs and wants.</strong>
										</p>
								</div>
							</div>
						</div><!--end 6 col-->
						...
						<div class="col-sm-6">
							<div class="feature feature-icon-large">
								...
								<div class="pull-right">
									<h5>WINDOWS TO INTERNET CONVERSION</h5>
									<p>
...
M.R.I.S deploys various software technologies to migrate, rewrite and convert any windows based application to a web based system.
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6 align-vertical no-align-mobile">
							...
							<p class="lead">
							We realized that clients have different and unique needs from software applications in order to perform their specific tasks. M.R.I.S saw a void that needed to be filled by developing <b>customized</b> or bespoke software application.<br><br>
                                
                               At M.R.I.S we develop <b>windows</b> and <b>web based</b> software application, which we programme using most of the latest Microsoft technologies in the market to meet our client's needs.<br><br>  
	  ...
	  <table style="border:none;">
                                <tr>
                                <td style="border:none;"><img src="img/check2.png">&nbsp;&nbsp;&nbsp;Microsoft</td>
                                </tr>
                                <tr>
                                <td style="border:none;"><img src="img/check2.png">&nbsp;&nbsp;&nbsp;PHP</td>
                                </tr>
                                <tr>
                                <td style="border:none;"><img src="img/check2.png">&nbsp;&nbsp;&nbsp;Database Software</td>
                                </tr>
                                <tr>
                                <td style="border:none;"><img src="img/check2.png">&nbsp;&nbsp;&nbsp;Java and more.</td>
                                </tr>
                                <tr>
                                <td style="border:none;"><img src="img/check2.png">&nbsp;&nbsp;&nbsp;HTML</td>
                                </tr>
                                <tr>
                                <td style="border:none;"><img src="img/check2.png">&nbsp;&nbsp;&nbsp;Adobe</td>
                                </tr>
                                <tr>
                                <td style="border:none;"><img src="img/check2.png">&nbsp;&nbsp;&nbsp;Web Server</td>
                                </tr>
                                <tr>
                                </table>
								<br><br>
                                
Our preferred database software is Microsoft Server because of its proven stable system, which is very much reliable and because of its abilities to adapt exceptional to Web and Desktop Applications. <br><br>
                                
                                Feel free to contact us for quotation on our product development solutions.

						</div>
						
						<div class="col-sm-6 text-center">
							<img alt="Product Image" class="product-image" src="img/soft-1.jpg">
						</div>
					</div><!--end of row-->
				</div><!--end of container-->
			</section>
